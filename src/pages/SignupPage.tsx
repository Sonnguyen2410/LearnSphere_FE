        ...
        <section className="flex w-full justify-center">
          <div className="auth-card relative w-full max-w-md overflow-hidden rounded-2xl p-8 shadow-2xl md:p-10">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#adc7ff] py-4 font-bold text-[#00285b] shadow-lg shadow-[#adc7ff]/20 transition-all hover:shadow-[#adc7ff]/30 active:scale-[0.98]"
                type="submit"
              >
                Tạo tài khoản
